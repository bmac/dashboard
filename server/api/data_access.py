...
def init_data():
        ...
        execute("insert into graphs('name', 'user_id', 'color') values ('foo', 1, 'yellow');")
        execute("insert into graphs('name', 'user_id', 'color') values ('exercise', 2, 'red');")
        execute("insert into graphs('name', 'user_id', 'color') values ('drawing', 2, 'blue');")
        execute("insert into events('graph_id', 'date') values (1, '2007-01-01');")
        execute("insert into events('graph_id', 'date', 'data') values (2, '2014-01-27', 5);")
        execute("insert into events('graph_id', 'date', 'data') values (2, '2014-01-29', 5);")
        execute("insert into events('graph_id', 'date', 'data') values (2, '2014-02-09', 5);")
        execute("insert into events('graph_id', 'date', 'data') values (2, '2014-02-10', 5);")
        execute("insert into events('graph_id', 'date', 'data') values (2, '2014-02-11', 5);")
        execute("insert into events('graph_id', 'date', 'data') values (2, '2014-02-12', 5);")
        execute("update users set alpha='exercise' where id=2;")
        execute("update users set bravo='github' where id=2;")
        execute("update users set charlie='drawing' where id=2;")
